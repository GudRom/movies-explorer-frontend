            ...
            {props.location.pathname !== "/" ? (
                ...
                <nav className="header__navigation">
                    <ul className="header__list">
                        <li className="header__item"><Link to="/movies" className={`header__link ${props.location.pathname === "/movies" && "header__link_active"}`}>Фильмы</Link></li>
                        <li className="header__item"><Link to="/saved-movies" className={`header__link ${props.location.pathname === "/saved-movies" && "header__link_active"}`}>Сохранённые фильмы</Link></li>
                    </ul>
